...
async def gen_thumb(videoid):
    ...
    try:
        ...
        font = ImageFont.truetype("ANNIEMUSIC/assets/font2.ttf", 40)
        font2 = ImageFont.truetype("ANNIEMUSIC/assets/font2.ttf", 70)
        arial = ImageFont.truetype("ANNIEMUSIC/assets/font2.ttf", 30)
        name_font = ImageFont.truetype("ANNIEMUSIC/assets/font.ttf", 30)
        para = textwrap.wrap(title, width=30)
        j = 0
        draw.text((5, 5), "Lyra Music Bot", fill="white", font=name_font)
        draw.text(
            (600, 150),
            "NOW PLAYING",
            fill="white",
        ...
        draw.text((600, 550), "Owner : @BotVerseRavi", (255, 255, 255), font=arial)
        try:
